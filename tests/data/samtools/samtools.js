...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = '../build/samtools.data';
      var REMOTE_PACKAGE_BASE = 'samtools.data';
  ...
  Module['FS_createPath']("/", "samtools", true, true);
Module['FS_createPath']("/samtools", "examples", true, true);
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_../build/samtools.data');

      };
      Module['addRunDependency']('datafile_../build/samtools.data');
   ...
   loadPackage({"files": [{"filename": "/samtools/examples/.gitignore", "start": 0, "end": 68, "audio": 0}, {"filename": "/samtools/examples/00README.txt", "start": 68, "end": 1383, "audio": 0}, {"filename": "/samtools/examples/ex1.fa", "start": 1383, "end": 4608, "audio": 0}, {"filename": "/samtools/examples/ex1.sam.gz", "start": 4608, "end": 119173, "audio": 0}, {"filename": "/samtools/examples/toy.fa", "start": 119173, "end": 119271, "audio": 0}, {"filename": "/samtools/examples/toy.sam", "start": 119271, "end": 120057, "audio": 0}], "remote_package_size": 120057, "package_uuid": "c7550e20-9f28-425b-93ce-eabe7c9d04f4"});
...
// console.log("lookup", lookup)
        ...
        // console.log("stat", path, dontFollow)
        ...
        // console.log("node.node_ops.getattr")
  ...
  function ___sys_stat64(path, buf) {try {
      path = SYSCALLS.getStr(path);
      // console.log(`___sys_stat64 ${path}`)
